...
import model.resnet56 as resnet56
...
def main():
    ...
    # non-KD mode: regular training to obtain a baseline model
        ...
        elif params.model_version == "vgg16":
            print("model: {}".format(params.model_version))
            #model = models.vgg19_bn(num_classes=args.num_class).cuda()
            model = vgg16.vgg16(num_classes=args.num_class).cuda()
        ...
        elif params.model_version == "resnet56":
            #model = resnet.ResNet50(num_classes=args.num_class).cuda()
            model = resnet56.get_resnet_model(num_classes=args.num_class).cuda()
            from torchsummary import summary
            print(summary(model,(3,32,32)))
